  ...
  useEffect(() => {
    const mockSpaces = [
      {
        ...
        available_spaces: 12,
        status: "active",
        qr_code: "PARK-IKJ-8392",
      },
      {
        id: 2,
        name: "Lagos Mall Parking",
        area: "Victoria Island",
        address: "45 Adeola Odeku St",
        price_per_hour: 800,
        total_spaces: 30,
        available_spaces: 5,
        status: "inactive",
        qr_code: "PARK-VI-2043",
      },
    ];
    ...
    const mockSessions = [
      ...
      },
      {
        id: 103,
        parking_space_id: 2,
        driver_name: "Daniel Uche",
        vehicle_plate: "KJA-567-AA",
        status: "active",
        total_amount: 1200,
      },
    ];
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold">
                      ₦{getSpaceRevenue(space.id).toFixed(2)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
...
<Button
  ...
  onClick={() => navigate(`/dashboard/manage-space?id=${space.id}`)}
>
  Manage Space
</Button>
